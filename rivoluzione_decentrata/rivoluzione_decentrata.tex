...
% copyright 2015 Marco Amadori <amadori@inbitcoin.it>
% 
% 
...
%
% deps: sudo apt-get install texlive-lang-italian texlive-latex-extra texlive-fonts-extra
% 
...
\def\UrlBreaks{\do\/\do-} % break urls on hypens and slash
...
conto corrente bancario, senza tuttavia che siate costretti ad aprirne
...
Block},\footnote{
\longurl{https://blockchain.info/it/tx/4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b}}
ad oggi.
...
che si sta diffondendo (standard \textsc{bip0032}  sugli \emph{hd-wallet}), 
si usano indirizzi nuovi ad ogni transazione e si mette al sicuro solo una \emph{masterkey}, che può 
generare tutti gli indirizzi dei quali potremmo aver bisogno in alcune vite.
Questa degli indirizzi bitcoin è una parte che il pubblico vedrà sempre meno, analogamente a
quello accaduto per gli indirizzi internet con l'introduzione del \textsc{dns}.}
se però, ad esempio, rendessi pubblico sul mio blog personale il mio
...
Marco Amadori \href{mailto:amadori@inbitcoin.it}{<amadori@inbitcoin.it>} \\
Imprenditore Bitcoin, già Tecnologo e Ricercatore presso la Fondazione Bruno Kessler (\url{https://fbk.eu}).
\end{minipage}
...
\begin{large}\textbf{È Bitcoin il nuovo Bitcoin.}\end{large}


\vfill

Marco Amadori, Fondatore di \url{inbitcoin.it} e Ricercatore e Tecnologo presso Blockchainlab.
...
\vfill
 ...
 \begin{figure}
  \centering
     ...
     {
     \subcaptionbox{% centering here generates an error
